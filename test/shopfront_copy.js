...
//         shop.changeOwner(newOwner, {from: owner})
//             .then(() => shop.getOwner())
...
//             .then(() => shop.itemsDatabase(id, {from: owner}))
//             .then(_product => {
//                 product = _product;
...
//             .then(() => {
//                 expectedExceptionPromise(
//                     () => shop.purchaseItem(id, purchasedQuantity, {from: Alice,
...
//         expectedExceptionPromise(() => shop.freeze(true, {from: Bob}))
//     )
...
//                 return shop.purchaseItem(id, purchasedQuantity, {from: Alice, value: purchasedQuantity * price})
//             })
//             .then(() => shop.withdrawFunds(withdrawalAmount, {from: owner}))
//             .then(_tx => {
//                 txObj = _tx; 
